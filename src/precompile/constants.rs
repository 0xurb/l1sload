...
pub const L1_SLOAD_BASE: u64 = 2_000;
...
pub const L1_SLOAD_PER_LOAD_BASE: u64 = COLD_SLOAD_COST + ETH_GET_STORAGE_AT_RPC_CALL_COST;
/// Max number of storage slots for l1sload operation (tentative).
pub const L1_SLOAD_MAX_NUM_STORAGE_SLOTS: usize = 5;
